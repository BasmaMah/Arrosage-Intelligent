...
import com.ensaj.ma.repository.GrandeurRepository;
...
/**
 * REST controller for managing {@link com.ensaj.ma.domain.Grandeur}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class GrandeurResource {
    ...
    public ResponseEntity<Grandeur> createGrandeur(@Valid @RequestBody Grandeur grandeur) throws URISyntaxException {
    ...
    public ResponseEntity<Grandeur> partialUpdateGrandeur(
        ...
        Optional<Grandeur> result = grandeurRepository
            ...
            .map(existingGrandeur -> {
                ...
                if (grandeur.getUnite() != null) {
                    existingGrandeur.setUnite(grandeur.getUnite());
                }
